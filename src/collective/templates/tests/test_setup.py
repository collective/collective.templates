...
class TestSetup(unittest.TestCase):
    """Test that collective.templates is properly installed."""

    layer = COLLECTIVE_TEMPLATES_INTEGRATION_TESTING
    ...
    def test_product_installed(self):
        """Test if collective.templates is installed."""
...
class TestUninstall(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.installer.uninstallProducts(['collective.templates'])
        setRoles(self.portal, TEST_USER_ID, roles_before)

    def test_product_uninstalled(self):
        """Test if collective.templates is cleanly uninstalled."""
